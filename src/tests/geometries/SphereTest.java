...
class SphereTest {
    ...
    public void testFindIntersections(){
        Sphere sphere=new Sphere(1,new Point3D(1,1,0));
        ...
        assertEquals(sphere.findIntersections(new Ray(new Vector(1, 1, 0), new Point3D(-1, 0, 0))),
        ...
        assertEquals(sphere.findIntersections(new Ray(new Vector(3, 1, 0), new Point3D(2, 1, 0))),
                "Sphere behind Ray");
